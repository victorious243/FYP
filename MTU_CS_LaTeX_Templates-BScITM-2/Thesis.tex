...
\title  {Logs Monitoring Security with AI Resolution}
\authors{Brandon Nkwenzum}
...
This report, Logs Monitoring Security, is submitted in partial fulfillment of the requirements of Level 8 \space in IT Management and Cybersecurity \space at Munster Technological University. I, Brandon Nkwenzum , declare that this thesis titled, Logs Monitoring Security, and the work represents substantially the result of my own work except where explicitly indicated in the text. This report may be freely copied and distributed provided the source is explicitly acknowledged. I confirm that:

\begin{itemize} 
\item[\tiny{$\blacksquare$}] This work was done wholly or mainly while in candidature Level 8  in IT Management and Cybersecurity at Munster technological University
